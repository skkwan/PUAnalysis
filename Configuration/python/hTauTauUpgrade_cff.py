...
TTanalysisConfigurator.addSelector('diTausIsolated','PATDiTauPairSelector','leg1.tauID("byVLooseIsolationMVArun2v1DBoldDMwLT")>0.5&&leg2.tauID("byVLooseIsolationMVArun2v1DBoldDMwLT")>0.5','TTIso',1)
