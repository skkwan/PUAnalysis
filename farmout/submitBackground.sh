...
farmoutAnalysisJobs  $1 $jobOptions --input-file-list=TTbar_200PU.txt           ${jobID}_TTbar_200PU  $tailOptions
farmoutAnalysisJobs  $1 $jobOptions --input-file-list=TTbar_0PU.txt             ${jobID}_TTbar_0PU    $tailOptions

farmoutAnalysisJobs  $1 $jobOptions --input-file-list=VBF_200PU.txt             ${jobID}_VBF_200PU  $tailOptions
farmoutAnalysisJobs  $1 $jobOptions --input-file-list=VBF_0PU.txt               ${jobID}_VBF_0PU    $tailOptions

farmoutAnalysisJobs  $1 $jobOptions --input-file-list=GGH_200PU.txt             ${jobID}_GGH_200PU  $tailOptions
farmoutAnalysisJobs  $1 $jobOptions --input-file-list=GGH_0PU.txt               ${jobID}_GGH_0PU    $tailOptions

farmoutAnalysisJobs  $1 $jobOptions --input-file-list=QCD_200PU.txt             ${jobID}_QCD_200PU  $tailOptions
